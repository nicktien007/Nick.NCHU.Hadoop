...
//        System.out.println(d1);
    ...
    @Test
    public void testCalcAverageOfPoint(){
        ...
        DayInfo t1Info = new DayInfo(t1);
        DayInfo t2Info = new DayInfo(t2);

        List<DayInfo> all_1 = new ArrayList<>();
        all_1.add(new DayInfo(p6String));
        all_1.add(new DayInfo(p7String));
        all_1.add(new DayInfo(p17String));
        all_1.add(new DayInfo(p10String));
        all_1.add(new DayInfo(p1String));
        all_1.add(new DayInfo(p18String));
        all_1.add(new DayInfo(p5String));
        all_1.add(new DayInfo(p13String));
        all_1.add(new DayInfo(p11String));
        all_1.add(new DayInfo(p12String));
        all_1.add(new DayInfo(p4String));
        all_1.add(new DayInfo(p3String));


        List<DayInfo> all_2 = new ArrayList<>();
        all_2.add(new DayInfo(p8String));
        all_2.add(new DayInfo(p9String));
        all_2.add(new DayInfo(p15String));
        all_2.add(new DayInfo(p16String));
        all_2.add(new DayInfo(p2String));
        all_2.add(new DayInfo(p14String));



        System.out.println("==========================================");
        System.out.println("distance1="+PM25.Reduce.calcAvgDistance(all_1,t1Info));
        System.out.println("distance2="+PM25.Reduce.calcAvgDistance(all_2,t2Info));
        System.out.println("==========================================");
    }
